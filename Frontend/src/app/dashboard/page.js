    ...
    <div className="bg-white shadow-sm rounded-lg p-4 mb-6 mx-auto max-w-md">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-grow bg-gray-100 p-2 rounded-full">
          <input
            type="text"
            placeholder="What's on your mind, Mel?"
...
// ProductCard Component with Carousel and Adjusted Card Size and Spacing
const ProductCard = () => {
...
// Main Content Component (with PostInput above the Graphics & Design section)
const MainContent = () => (
  <div className="ml-48 mt-16 p-8">
    <PostInput />

    <div className="flex justify-between items-center mb-4">
      <Typography variant="h4">Graphics & Design</Typography>
      <Button endIcon={<ArrowForwardIosIcon />} variant="contained" color="primary">
        See More
      </Button>
    </div>
