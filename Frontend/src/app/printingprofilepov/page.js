...
import { Menu as MenuIcon, Notifications as NotificationsIcon, Search as SearchIcon, AccountCircle as AccountCircleIcon, Dashboard as DashboardIcon, Chat as ChatIcon, ShoppingCart as ShoppingCartIcon, Brush as BrushIcon, Print as PrintIcon, Favorite as FavoriteIcon, ExitToApp as LogoutIcon, Star as StarIcon, StarHalf as StarHalfIcon, Message as MessageIcon, ArrowBackIos, ArrowForwardIos, ExpandMore as ExpandMoreIcon, Edit as EditIcon, Person as PersonIcon, CameraAlt as CameraIcon, Phone as PhoneIcon, AccessTime as AccessTimeIcon, LocationOn as LocationOnIcon  } from '@mui/icons-material';
    ...
    <div className={`h-screen bg-blue-800 text-white flex flex-col fixed transition-all duration-300 ${isSidebarExpanded ? 'w-48' : 'w-16'}`}>
      ...
      {isSidebarExpanded && (
        <div className="flex flex-col items-center p-4">
          <Avatar alt="MT Printing Services" src="/static/images/avatar/1.jpg" sx={{ width: 60, height: 60 }} />
          <Typography variant="h6" className="mt-2">MT Printing</Typography>
          <Typography variant="body2">Printing Provider</Typography>
        </div>
      )}
